...
bool ModulePhysics3D::CleanUp()
{
	...
	p2List_item<PhysBody3D*>*	iterator2 = phbody_list.getFirst();

	while (iterator2 != nullptr)
	{
		delete iterator2->data;
		iterator2 = iterator2->next;
	}
	phbody_list.clear();

	p2List_item<btCollisionShape*>*	iterator = coll_list.getFirst(); 
